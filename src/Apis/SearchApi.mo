...
module {
    ...
    public func search(config : Config, q : Text, type_ : [ItemTypeInner], market : Text, limit : Nat, offset : Nat, includeExternal : IncludeExternal) : async* Search200Response {
        ...
        let baseUrl__ = baseUrl # "/search"
            # "?" # "q=" # q # "&" # "type=" # debug_show(type_) # "&" # "market=" # market # "&" # "limit=" # Int.toText(limit) # "&" # "offset=" # Int.toText(offset) # "&" # "include_external=" # IncludeExternal.toText(includeExternal);
        ...
        if (response.status >= 200 and response.status < 300) {
            ...
            (switch (Search200Response.fromCandidValue(_)) {
                case (?value) value;
